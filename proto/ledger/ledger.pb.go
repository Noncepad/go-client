...
var file_ledger_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x42, 0x1f, 0x5a, 0x1d, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x70, 0x61, 0x64,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x69, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6c,
...
var file_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_ledger_proto_goTypes = []interface{}{
	...
	nil,                         // 11: ledger.GroupAccount.SourceEntry
	nil,                         // 12: ledger.Equity.IncomeEntry
	(*base.ShortCommodity)(nil), // 13: base.ShortCommodity
	(base.Currency)(0),          // 14: base.Currency
	(base.Crypto)(0),            // 15: base.Crypto
	(*base.SecurityID)(nil),     // 16: base.SecurityID
	(*base.Value)(nil),          // 17: base.Value
	(*base.Commit)(nil),         // 18: base.Commit
}
var file_ledger_proto_depIdxs = []int32{
	...
	13, // 4: ledger.CommodityMaster.commodity:type_name -> base.ShortCommodity
	...
	14, // 8: ledger.CurrencyMaster.currency:type_name -> base.Currency
	15, // 9: ledger.CryptoMaster.crypto:type_name -> base.Crypto
	16, // 10: ledger.ProductMaster.security_id:type_name -> base.SecurityID
	17, // 11: ledger.Account.balance:type_name -> base.Value
	5,  // 12: ledger.GroupAccount.top:type_name -> ledger.Account
	11, // 13: ledger.GroupAccount.source:type_name -> ledger.GroupAccount.SourceEntry
	6,  // 14: ledger.Equity.top:type_name -> ledger.GroupAccount
	12, // 15: ledger.Equity.income:type_name -> ledger.Equity.IncomeEntry
	6,  // 16: ledger.Income.revenue:type_name -> ledger.GroupAccount
	6,  // 17: ledger.Income.expense:type_name -> ledger.GroupAccount
	18, // 18: ledger.Transaction.commit:type_name -> base.Commit
	5,  // 19: ledger.GroupAccount.SourceEntry.value:type_name -> ledger.Account
	8,  // 20: ledger.Equity.IncomeEntry.value:type_name -> ledger.Income
